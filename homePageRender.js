...
async function renderNewsFeed(results) {
    ...
    if(long.length < 80){
        ...
        $news.append('<div><li class="NYT"><a class="sourceLink" href="'+ results[i].short_url +'"><img alt="News source thumbnail" src=" '+ results[i].multimedia[1].url +'"><h1>'+ title+'</h1></a></li></div>');
    }
};
